...
- (void)btnClick:(UIButton *)btn
{
    if (btn.tag == ZCTradeInputViewButtonTypeWithCancle) {  // 取消按钮点击
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"zhifujianpan" object:nil userInfo:nil];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"zhifujianpan1" object:nil userInfo:nil];
        // 包装通知字典
